...
function renderCompetencesEnseignant(){
  ...
  if(legend){
    ...
    legend.innerHTML = '<div style="background:#fff;border-radius:10px;padding:12px 16px;border:1px solid var(--gb);margin-bottom:4px">'
      + '<div style="font-size:13px;font-weight:800;color:#1C1C1E;margin-bottom:4px">Vue référentiel — Progression de la classe</div>'
  ...
  grid.innerHTML = COMP.map(function(c){
    ...
    return '<div class="cc" style="border-left:4px solid '+statusColor+'">'
      ...
      + '</div>'
      + '<div style="font-size:13px;font-weight:800;color:#1C1C1E;margin-bottom:10px">'+c.label+'</div>'
      + (total > 0
...
function openProduit(id){
  ...
  const compsHtml = comps.map(function(cp){
    ...
    const cpC = CAT_CFG[cp.cat] || {col:'#B91C1C'};
    return '<div onclick="openProduit(\''+cp.id+'\')" style="display:flex;align-items:center;gap:10px;padding:8px;border:1px solid #E5E7EB;border-radius:10px;cursor:pointer;background:#fff" onmouseover="this.style.borderColor=\''+cpC.col+'\'" onmouseout="this.style.borderColor=\'#E5E7EB\'">'
      ...
      +'</div>'
      +'<div style="flex:1;min-width:0"><div style="font-size:10px;font-weight:700;color:#1C1C1E;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">'+cp.nom+'</div>'
  ...
  fiche.innerHTML = '<div style="border-radius:14px;overflow:hidden;background:#fff;box-shadow:0 4px 24px rgba(0,0,0,.08);border:1px solid #E8EDF5">'
    ...
    +'<div style="font-size:19px;font-weight:900;color:#1C1C1E;line-height:1.2;margin-bottom:6px">'+p.nom+'</div>'
    ...
    +'<div style="background:#F0F4FF;border-radius:10px;padding:10px;text-align:center"><div style="font-size:9px;color:#6B7280;font-weight:700;text-transform:uppercase;margin-bottom:4px">Achat HT</div><div style="font-size:18px;font-weight:900;color:#1C1C1E">'+p.pa+' €</div></div>'
    ...
    +'<div style="font-size:11px;font-weight:800;color:#1C1C1E;text-transform:uppercase;letter-spacing:.5px;margin-bottom:8px">📋 Caractéristiques</div>'
    ...
    +'</div>'
    +'<div style="padding:16px 18px;border-right:1px solid #F3F4F6">'
    +'<div style="font-size:11px;font-weight:800;color:#1C1C1E;text-transform:uppercase;letter-spacing:.5px;margin-bottom:8px">💬 Argumentaire vendeur</div>'
    +argsHtml
    +'</div>'
    +'<div style="padding:16px 18px">'
    +'<div style="font-size:11px;font-weight:800;color:#1C1C1E;text-transform:uppercase;letter-spacing:.5px;margin-bottom:8px">🔗 Produits complémentaires</div>'
