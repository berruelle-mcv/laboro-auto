...
<ul>
<li><strong>Mauvaise réponse</strong> — insister immédiatement sur une offre commerciale ("mais j'ai une super promo en ce moment !") : le prospect se sent poussé, pas écouté</li>
<li><strong>Bonne réponse</strong> — reformuler pour montrer qu'on a entendu ("je comprends, votre flotte est donc récente"), puis ouvrir une porte sans forcer ("puis-je vous recontacter dans quelques mois, au moment où vous commencerez à anticiper le prochain renouvellement ?")</li>
</ul>
...
<ul>
<li><strong>Mauvais réflexe</strong> — dire que le 2008 "n'est pas terrible" ou dénigrer le concurrent : ça ne convainc jamais, et ça donne une image négative du vendeur</li>
<li><strong>Bon réflexe</strong> — reconnaître honnêtement le différentiel de prix, puis expliquer ce qu'il finance : équipements inclus dès la finition de base, garantie constructeur, SAV local</li>
</ul>
...
<ul>
<li><strong>Mauvaise réponse</strong> — refuser sèchement, ou céder au-delà du cadrage sans en référer à un responsable</li>
<li><strong>Bonne réponse</strong> — accorder les 300 € autorisés, puis proposer une contrepartie de valeur équivalente pour le client sans sortir du cadre : par exemple une garantie étendue offerte plutôt qu'une remise supplémentaire</li>
</ul>
...
<ul>
<li><strong>Mauvaise annonce</strong> — rester vague ("il y a un peu de retard") ou attendre que le client s'inquiète et appelle lui-même</li>
<li><strong>Bonne annonce</strong> — contacter le client avant qu'il ne s'inquiète, expliquer la cause réelle (retard fournisseur, pas une erreur Vasseur), donner un nouveau délai précis, et proposer un geste si pertinent (priorité sur le prochain rendez-vous d'entretien, par exemple)</li>
</ul>
